...
# from frameHandlers import applyOpenCvRectangles
...
# # modelW = D0ModelWrapper(modelPath)
...
print("START")
modelPath = "./Python/Models/D0"
model = D0ModelWrapper(modelPath)
handler = ImageHandler(model, OpenCvRectanglesApplier)
handler.handle(inputFile, outputFile)
print("END")